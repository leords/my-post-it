import { ArrowLeft, CircleNotch, Divide } from "phosphor-react";
...
export function NewForm({type, userLoggedID, projectID, renderComponent}:Props) {
    ...
    return(
        <div className="flex justify-center items-center max-w-[500px] h-auto mx-auto ">
            ...
            {type == 'task' && (
                <div className="flex flex-col p-6 pt-10 border items-center justify-center bg-white w-full gap-2 rounded-lg shadow-md">
                    ...
                    <div className={`w-full ${loading == true ? ('opacity-20') : ('opacity-100')}`}>
